...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${staticurl}/pagescript/userinfos/strongpoint/css/main.css">
		<!--
		<link rel="stylesheet/less" href="${staticurl}/pagescript/userinfos/strongpoint/less/main.less"/>	
		<#include "../inc/lessconf.ftl">
		-->
		<#include "../inc/requireconf.ftl">
		<script defer src="${staticurl}/common/require.js" data-main="${staticurl}/pagescript/userinfos/strongpoint/js/main.js"></script>
	</head>
	<body>
