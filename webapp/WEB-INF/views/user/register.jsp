...
<c:set var="title" value="用户注册 - 正和岛" />
...
<div id="page-content-inner">
	...
	<div id="register-panel">
		<form id="form-register" autocomplete="off" class="xform" action="/doRegister" data-redirect="${empty header.Referer ? '/' : header.Referer}">
			<div class="input-bundle label-with">
				...
				<div class="input-row">
					...
					<div id="flex-cell-code" class="flex-cell">
						<input id="txt-phone" name="mobile" type="text" placeholder="" maxlength="20" data-empty-error="手机号不能为空" data-check-function="checkPhone" />
					</div>
		...
		<div class="flex-cell button-container">
			<a id="btn-register" class="button" href="javascript:;" data-toggle-text="正在提交...">注 册</a>
		</div>
	</div>
